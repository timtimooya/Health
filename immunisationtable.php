...
<body>
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="dashboard.php"><img src="img/kenya.png" width="30%">Ministry of Health</a>
...
echo "<td><a href='immunisationcert.php?id=".$row['id']."'>immunisation</a></td>";
echo "</tr>";
}
echo "</table>";
